...
This was just a brief introduction to iptables/netfilter. If you want to know more about iptables configuration, you can have a look at this excelent and detailed tutorial : http://www.frozentux.net/iptables-tutorial/iptables-tutorial.html
\newpage
