 ...
 \end{frame}
  ...
  \begin{frame}
    ...
    \begin{example}
      ...
      -A INPUT -m tcp -p tcp --dport 80 -j ACCEPT\\
      -A INPUT -m tcp -p tcp --dport https -j ACCEPT\\
      {\color{blue}-A OUTPUT -m tcp -p tcp --sport ssh -j ACCEPT\\
  ...
  \begin{frame}
    ...
    \begin{example}
      ...
      -A INPUT -m tcp -p tcp --dport 80 -j ACCEPT\\
      -A INPUT -m tcp -p tcp --dport https -j ACCEPT\\
      {\color{blue}-A OUTPUT -m state --state ESTABLISHED,RELATED -j ACCEPT}}
    \end{example}
  ...
  \begin{frame}
    ...
    \begin{example}
      \small{\sout{{\color{red}-A INPUT -p tcp -m tcp --dport 445 -j admin\_IP}}\\
      -A INPUT -p tcp -m tcp --dport 445 -j webmaster\_IP\\
      \sout{{\color{red}-A INPUT -p tcp -m tcp --dport 139 -j admin\_IP}}\\
      -A INPUT -p tcp -m tcp --dport 139 -j webmaster\_IP}
    \end{example}
