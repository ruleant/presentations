...
\begin{document}
  ...
  \begin{frame}
    ...
    \end{itemize}
    \begin{example}
      \small{iptables -A \textbf{INPUT} -m tcp -p tcp --dport ssh -j ACCEPT}
    \end{example}
  ...
  \begin{frame}
    ...
    \end{itemize}
    \begin{example}
      \small{iptables -A INPUT \textbf{-m tcp -p tcp --dport ssh -s 10.0.0.0/8} -j ACCEPT}
    \end{example}
  \end{frame}
  \begin{frame}
    \frametitle{Targets}
    ...
    \end{itemize}
    \begin{example}
      \small{iptables -A INPUT -m tcp -p tcp --dport ssh \textbf{-j ACCEPT}}
    \end{example}
  \end{frame}
  \begin{frame}
